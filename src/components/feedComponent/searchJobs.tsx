...
const SearchJobs: React.FC<Props> = (props: Props) => {
  const history = useHistory();
  useEffect(() => {
    props.dispatch(clearJobFilter());
  }, []);
  return (
    <div className={props.view.view === 'search' ? 'jobContainer' : 'ghost'}>
      <TextField
        value={props.job.filter}
        onChange={e => {
          props.dispatch(sendFilterJobs(e.target.value));
        }}
      >
        Search Jobs
      </TextField>
