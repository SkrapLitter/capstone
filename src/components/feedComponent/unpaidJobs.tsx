...
const UnpaidJobs: React.FC<Props> = (props: Props) => {
  const history = useHistory();
  return (
    <div className={props.view.view === 'unpaid' ? 'jobContainer' : 'ghost'}>
      {props.job.unpaidJobs.length ? (
        props.job.unpaidJobs.map(job => {
          return (
